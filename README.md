# 異常検出システム - 汎用データセット対応版

AI異常検出システムです。MVTecデータセットとカスタムデータセットの両方に対応し、様々な異常検出タスクに活用できます。

## 🎯 主要機能

- **汎用データセット対応**: MVTec AD全15カテゴリ + カスタムデータセット
- **シンプルで分かりやすい実装**: コードの可読性を最優先
- **完全機能実装**: TODOなしの完成形
- **工場環境対応**: CPU推論最適化、ユーザーフレンドリーなGUI
- **モック対応**: 依存ライブラリがない環境でも動作確認可能
